		...
		setPositiveAlternance: function (value) {
		    ...
		    this.rpigpio.write(GPIO_POS, value, function(err) {
		        if (err) throw err;
		          ...
		          if(currentAcova.debug) currentAcova.log('GPIO_POS (' + GPIO_POS + ') is now', value ? "High" : "Low");
		        }
		    });
		...
		setNegativeAlternance: function (value) {
		    ...
		    this.rpigpio.write(GPIO_NEG, value, function(err) {
		        if (err) throw err;
		          ...
		          if(currentAcova.debug) currentAcova.log('GPIO_NEG (' + GPIO_NEG +') is now', value ? "High" : "Low");
		        }
		    });
