...
module.exports = function Acova (GPIO_POS, GPIO_NEG) {
	...
	return {
		...
		getCurrentStateToString: function() {
			switch (this.currentState) {
				case COMFORT : return "COMFORT"; break;
				case COMFORT_MINUS_ONE : return "COMFORT_MINUS_ONE"; break;
				case COMFORT_MINUS_TWO : return "COMFORT_MINUS_TWO"; break;
				case ECO : return "ECO"; break;
				case NO_FROST : return "NO_FROST"; break;
				case OFF : return "OFF"; break;
				default: return "Error on getCurrentStateToString()";
			}
		},
