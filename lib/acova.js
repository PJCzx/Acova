...
module.exports = function Acova (name, GPIO_POS, GPIO_NEG, raspberry) {
	...
	return {
		...
		log: function() {
			var logline = "";
			for (var argument of arguments) logline += argument + "";
		...
		setPositiveAlternance: function (value) {
		    ...
		    this.rpigpio.write(GPIO_POS, value, function(err) {
		        if (err) throw err;
		          ...
		          currentAcova.log(Date(), currentAcova.name, 'GPIO_POS (' + GPIO_POS + ') is now', value ? "High" : "Low");
		        }
		    });
		...
		setNegativeAlternance: function (value) {
		    ...
		    this.rpigpio.write(GPIO_NEG, value, function(err) {
		        if (err) throw err;
		          ...
		          currentAcova.log(Date(), currentAcova.name, 'GPIO_NEG (' + GPIO_NEG +') is now', value ? "High" : "Low");
		        }
		    });
