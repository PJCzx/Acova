...
module.exports = function Acova (name, GPIO_POS, GPIO_NEG) {
		...
		setPositiveAlternance: function (value) {
		    ...
		    rpigpio.write(GPIO_POS, value, function(err) {
		        if (err) throw err;
		          ...
		          console.log(Date(), this.name, 'GPIO_POS (' + GPIO_POS + ') is now', value ? "High" : "Low");
		        }
		    });
		...
		setNegativeAlternance: function (value) {
		    ...
		    rpigpio.write(GPIO_NEG, value, function(err) {
		        if (err) throw err;
		          ...
		          console.log(Date(), this.name, 'GPIO_NEG (' + GPIO_NEG +') is now', value ? "High" : "Low");
		        }
		    });
